...
import { BranchesOutlined, ClockOutlined, FileTextOutlined } from "../icons";
import { relTime } from "./DashboardView";
import { useIdentity } from "../identity";
import UserAvatar from "./UserAvatar";
import { crRef } from "../api";
import { STATUS, statusColor, statusOf, typeMark, type FlowStatus } from "../changestatus";
import type { BranchLane, ChangeRequest, Commit, TimelineEntry } from "../api";
...
// The status and type vocabulary lives in ../changestatus, because a
// parameter's own history draws these same states at a tenth of this size and
// two hand-made copies of "rejected is red, broken-dashed and crossed" is
// exactly how one of them ends up saying amber next year.
